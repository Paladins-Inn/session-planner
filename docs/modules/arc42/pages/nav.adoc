...
* xref:index.adoc[session-planner arc42 architecture documentation]
** Context
...
**** Level 3
** Runtime view
*** xref:06_runtime_view/session-planner.adoc[]
...
*** xref:session-planner:ROOT:glossary.adoc[] (session-planner Manual)
*** xref:session-planner:ROOT:bibliography.adoc[] (session-planner Manual)
