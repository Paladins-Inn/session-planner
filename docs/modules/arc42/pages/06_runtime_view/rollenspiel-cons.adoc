...
.Web based UI of the session-planner system
...
.REST API of the session-planner system
[cols="<.<4,<.<4m,<.<8m,<.<4a",options="header",frame="topbot",grid="rows"]
|===
| Name | Method | URL | Permission
...
[[runtime-session-planner-transcludes]]
== Transcludes
.Transcludes of session-planner to be included on other pages.
...
[[runtime-session-planner-scheduled]]
== Scheduled Jobs
